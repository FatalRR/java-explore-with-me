...
public class CloseRequestsServiceImpl implements CloseRequestsService {
    ...
    public ParticipationRequestDto createRequestsByUserOtherEvents(int userId, int eventId) {
        ...
        return RequestsMap.mapToParticipationRequestDto(repository.save(request));
    }
    ...
    public List<ParticipationRequestDto> getRequestsByUser(int userId, int eventId) {
        ...
        return RequestsMap.mapToListParticipationRequestDto(repository.findParticipationRequestsByEventsWithRequests_IdAndEventsWithRequests_Initiator_Id(eventId, userId));
    }
